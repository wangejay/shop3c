...
// 如果你正在加載的 script 是跨子網域的，請取消下行的註釋並更改此 document.domain 的值。
...
?>
	...
	<title>新增 Box 區塊</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="BoxType">Box 類型 :</label>
	...
	<p>
		<label for="Boxalign">Box 對齊 :</label>
		<select id="Boxalign" name="Boxalign">
			<option value=""></option>
			<option value="alignright">靠右</option>
			<option value="alignleft">靠左</option>
			<option value="aligncenter">置中</option>
		</select>
	</p>
	<p>
		<label for="BoxClass">自訂 Class :</label>
		<input id="BoxClass" name="BoxClass" type="text" value="" />
	</p>
	</p>
	<p>
		<label for="BoxWidth">Box 寬度 :</label>
		<input id="BoxWidth" name="BoxWidth" type="text" value="" />
	</p>
	<p>
		<label for="BoxContent">內容 : </label>
		<textarea id="BoxContent" name="BoxContent" col="20"></textarea>
	</p>
	<p><a class="add" href="javascript:AddBoxes.insert(AddBoxes.e)">插入到文章中</a></p>
</form>
...
<form id="GalleryShortcode">
	<p>
		<label for="ButtonColor">按鈕類型 :</label>
	...
	<p>
		<label for="Buttonsize">按鈕尺寸 :</label>
	...
	<p>
		<label for="Buttonlink">按鈕鏈結網址 :</label>
		<input id="Buttonlink" name="Buttonlink" type="text" value="http://" />
	</p>
	<p>
		<label for="Buttontarget">在新視窗開啟鏈結 : </label>
		<input id="Buttontarget" name="Buttontarget" type="checkbox" value="true" />
	</p>
	</p>
	<p>
		<label for="Buttontext">按鈕文字 :</label>
		<input id="Buttontext" name="Buttontext" type="text" value="" />
	</p>

	<p><a class="add" href="javascript:AddButtons.insert(AddButtons.e)">插入到文章中</a></p>
</form>
...
<form id="GalleryShortcode">
	...
	<p><a class="add" href="javascript:Author.insert(Author.e)">插入到文章中</a></p>
</form>
...
<?php } elseif( $page == 'flickr' ){ ?>
	...
	<title>新增來自 Flickr 的照片</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="FlickrID">你的 Flickr 帳戶 Id</label>
		<input id="FlickrID" name="FlickrID" type="text" value="" />
		<small>(點此連結到 <a href="http://www.idgettr.com">idGettr</a> 網站去取得)</small>

	</p>
	<p>
		<label for="Photos">照片數量 :</label>
		<input id="Photos" name="Photos" type="text" value="" />

	</p>
	<p>
		<label for="PhotosOrder">照片排序 : </label>
		<select id="PhotosOrder" name="PhotosOrder">
			<option value="latest">最新照片</option>
			<option value="random">隨機選取</option>
		</select>
	</p>
	<p><a class="add" href="javascript:AddFlickr.insert(AddFlickr.e)">插入到文章中</a></p>
	</form>
...
<?php } elseif( $page == 'audio' ){ ?>
	...
	<title>新增 Mp3 播放器</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="mp3Url">Mp3 檔案網址 : </label>
		<input id="mp3Url" name="mp3Url" type="text" value="" />
	</p>
	<p>
		<label for="m4aUrl">M4A 檔案網址 : </label>
		<input id="m4aUrl" name="m4aUrl" type="text" value="" />
	</p>
	<p>
		<label for="oggUrl">OGG 檔案網址 : </label>
		<input id="oggUrl" name="oggUrl" type="text" value="" />
	</p>

	
	<p><a class="add" href="javascript:AddAudio.insert(AddAudio.e)">插入到文章中</a></p>
</form>
...
<form id="GalleryShortcode">
	...
	<p><a class="add" href="javascript:toggle.insert(toggle.e)">插入到文章中</a></p>
</form>
...
<?php } elseif( $page == 'twitter' ){ ?>
	...
	<title>新增你的最新推訊（Tweets）</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="TwitterID">帳號</label>
		<input id="TwitterID" name="TwitterID" type="text" value="" />

	</p>
	<p>
		<label for="tweets">推訊數量 :</label>
		<input id="tweets" name="tweets" type="text" value="" />

	</p>
	<p>
		<label for="avatar">顯示大頭貼 : </label>
		<input id="avatar" name="avatar" type="checkbox" value="true" />
	</p>
	
	<p><a class="add" href="javascript:AddTwitter.insert(AddTwitter.e)">插入到文章中</a></p>
</form>
...
<?php } elseif( $page == 'feeds' ){ ?>
	...
	<title>顯示 Feeds</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="feedurl">RSS feed 網址</label>
		<input id="feedurl" name="feedurl" type="text" value="" />

	</p>
	<p>
		<label for="numberFedds">Feeds 數量 :</label>
...
<?php } elseif( $page == 'lightbox' ){ ?>
	...
	<title>新增燈箱效果（LightBox）</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="ImgUrl">圖片網址或 Youtube / Vimeo 影片網址 : </label>
		<input id="ImgUrl" name="ImgUrl" type="text" value="http://" />

	</p>
	<p>
		<label for="ImgTitle">標題 : </label>
		<input id="ImgTitle" name="ImgTitle" type="text" value="" />

	</p>
	<p>
		<label for="ImgContent">內容 : </label>
		<textarea id="ImgContent" name="ImgContent" cols="45" rows="5" ></textarea>
	</p>
	
	<p><a class="add" href="javascript:Addlightbox.insert(Addlightbox.e)">插入到文章中</a></p>
</form>
...
<form id="GalleryShortcode">
	<p>
		<label for="VideoUrl" style="width:230px">影片網址 :</label>
		<input id="VideoUrl" name="VideoUrl" type="text" value="http://" />
		<br /><small>支援 : YouTube, Vimeo, Viddler, Qik, Hulu, FunnyOrDie, DailyMotion, WordPress.tv 和 blip.tv</small>
	</p>
	<p>
	...
	<p><a class="add" href="javascript:AddVideo.insert(AddVideo.e)">插入到文章中</a></p>
</form>
...
<?php } elseif( $page == 'googlemap' ){ ?>
	...
	<title>插入 Google 地圖</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="MapUrl">地圖網址 : </label>
		<input id="MapUrl" name="MapUrl" type="text" value="http://" />

	</p>
	<p>
		<label for="Mapalign">Map 對齊位置 :</label>
	...
	<p><a class="add" href="javascript:googlemap.insert(googlemap.e)">插入到文章中</a></p>
</form>
...
<form id="GalleryShortcode">
	...
	<p>
		<label for="Gravities">萬有引力 :</label>
		<select id="Gravities" name="Gravities">
			<option value="nw">西北方</option>
			<option value="n">北方</option>
			<option value="ne">東北方</option>
			<option value="w">西方</option>
			<option value="e">東方</option>
			<option value="sw">西南方</option>
			<option value="s">南方</option>
			<option value="se">東南方</option>
		</select>
	</p>
	<p>
		<label for="Content">內容 : </label>
...
<form id="GalleryShortcode">
	...
	<p>
		<label for="Facebook"><strong>Facebook 讚按鈕</strong></label>
		<input id="Facebook" name="Facebook" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />

	<p>
		<label for="tweet"><strong>Tweet 按鈕</strong></label>
		<input id="tweet" name="tweet" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="digg"><strong>Digg 按鈕</strong></label>
		<input id="digg" name="digg" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="stumble"><strong>Stumble 按鈕</strong></label>
		<input id="stumble" name="stumble" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="Google"><strong>Google+ 按鈕</strong></label>
		<input id="Google" name="Google" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="feedburner"><strong>Feedburner 訂閱人數按鈕</strong></label>
		<input id="feedburner" name="feedburner" type="checkbox" value="true" />
		<input id="feedburnerName" name="feedburnerName" type="Text" value="Feed 名稱" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="pinterest"><strong>Pinterest 按鈕</strong></label>
		<input id="pinterest" name="pinterest" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="TwitterID"><strong>Twitter 追蹤按鈕</strong></label>
		<input id="twitterFollow" name="twitterFollow" type="checkbox" value="true" />
		<input id="TwitterID" name="TwitterID" type="text" value="帳號" />
	</p>
	<p>
		<label for="Large">大型按鈕 : </label>
		<input id="Large" name="Large" type="checkbox" value="true" />
	</p>
	<p>
		<label for="count">顯示追蹤人數 : </label>
