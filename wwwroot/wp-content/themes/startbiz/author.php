...
get_header(); ?>
	<div class="content">
		...
		<div class="page-head">
			...
			<h2 class="page-title">
				<?php printf( _( '作者存檔: %s' ),  get_the_author() ); ?>
			</h2>
			<?php if( stf_get_option( 'author_rss' ) ): ?>
			<a class="rss-cat-icon ttip" title="訂閱作者文章"  href="<?php echo get_author_feed_link( get_the_author_meta('ID') ); ?>"></a>
			<?php endif; ?>
			<div class="stripe-line"></div>
			
			<?php if( stf_get_option( 'author_bio' ) ): ?>
			<div class="author-bio">
				<div id="author-avatar">
					<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'stf_author_bio_avatar_size', 60 ) ); ?>
				</div><!-- #author-avatar -->
