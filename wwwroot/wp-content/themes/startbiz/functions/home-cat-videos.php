 ...
 ?>
		<section class="cat-box video-box">
			...
			<div class="cat-box-content">
				...
				<?php if($count == 1) : ?>
					<li <?php stf_post_class( 'big-video-column' ); ?>>
						<?php stf_video(); ?>
					</li><!-- .first-news -->
					<?php else: ?>
					<?php if ( function_exists("has_post_thumbnail") && has_post_thumbnail() ) : ?>			
					<li <?php stf_post_class( 'videos-item'.$count ); ?>>
						<div class="post-thumbnail">
							<a class="ttip" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" rel="bookmark"><?php stf_thumb( 'stf-medium' ); ?><span class="overlay-icon"></span></a>
						</div><!-- post-thumbnail /-->
					</li>
					<?php endif; ?>			
					<?php endif; ?>
