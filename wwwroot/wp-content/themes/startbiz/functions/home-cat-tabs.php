...
*/
function stf_home_tabs(){
	$home_tabs_active = stf_get_option('home_tabs_box');
	$home_tabs = stf_get_option('home_tabs');
	$Posts = 5;
	...
	<div id="cats-tabs-box" class="cat-box-content clear cat-box">
		...
		<?php
			...
			<?php if($cat_query->have_posts()): ?>
				...
				<?php if($count == 1) : ?>
					<li <?php stf_post_class('first-news'); ?>>
						...
						<div class="entry">
							<?php stf_excerpt_home() ?>
							<a class="more-link" href="<?php the_permalink() ?>">繼續閱讀 &raquo;</a>
						</div>
					</li><!-- .first-news -->
					<?php else: ?>
