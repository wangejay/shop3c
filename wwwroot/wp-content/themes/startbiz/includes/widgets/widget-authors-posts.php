...
*/
add_action( 'widgets_init', 'stf_authors_posts_widget' );
function stf_authors_posts_widget() {
	register_widget( 'stf_authors_posts' );
}
class stf_authors_posts extends WP_Widget {

	function stf_authors_posts() {
	...
	function widget( $args, $instance ) {
		...
		<?php echo $after_title; ?>
				<ul>
					<?php stf_last_posts_cat_authors($no_of_posts , $thumb , $cats_id)?>	
				</ul>
		<div class="clear"></div>
	<?php 
		echo $after_widget;
	...
	function form( $instance ) {
		$defaults = array( 'title' => '作者文章' , 'no_of_posts' => '5' , 'cats_id' => '1' , 'thumb' => 'true' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb' ); ?>">顯示作者大頭貼 : </label>
