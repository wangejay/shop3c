...
<?php if( stf_get_option('slider_type') == 'elastic' ): ?>
	...
	<div id="ei-slider" class="ei-slider">
		...
		<?php $i= 0;
			...
			<?php if ( function_exists("has_post_thumbnail") && has_post_thumbnail() ) : ?>
				<a href="<?php the_permalink(); ?>"><?php stf_thumb( 'slider' ); ?></a>
			<?php endif; ?>
				<div class="ei-title">
		...
		<?php $i= 0;
			while ( $featured_query->have_posts() ) : $featured_query->the_post(); $i++; ?>
			<li><a href="#">幻燈片 <?php echo $i; ?></a><?php stf_thumb( 'stf-medium' ); ?></li>
    		<?php endwhile;?>
		</ul><!-- ei-slider-thumbs -->
	</div>
	<?php endif; ?>
...
<?php endif; ?>
	...
	<?php
		...
		$custom_slider_args = array( 'post_type' => 'stf_slider', 'p' => $slider_query, 'no_found_rows' => 1  );
...
<?php if( stf_get_option('slider_type') == 'elastic' ): ?>
	...
	<div id="ei-slider" class="ei-slider">
		...
		<?php $i= 0;
			...
			<li>
				<img src="<?php echo stf_slider_img_src( $slide['id'] , 'slider' ) ?>" alt="<?php  echo stripslashes( $slide['title'] )  ?>" />
	...
	<div id="flexslider" class="flexslider">
		...
		<?php while ( $custom_slider->have_posts() ) : $custom_slider->the_post();
			...
			<li>
				...
				<img src="<?php echo stf_slider_img_src( $slide['id'] , 'slider' ) ?>" alt="" />
				<?php if( !empty( $slide['link'] ) ):?></a><?php endif; ?>
				<?php if( !empty( $slide['title'] ) || !empty( $slide['caption'] ) ) :?>
				<div class="slider-caption">
